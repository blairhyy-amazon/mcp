...
def expand_service_wildcard_patterns(
    ...
    if service_patterns or service_fuzzy_matches:
        ...
        try:
            ...
            filtering_stats['filtered_out'] = (
                filtering_stats['total_services'] - filtering_stats['instrumented_services']
            )
            ...
            for original_target, pattern in service_patterns:
                ...
                logger.debug(
                    f"Service pattern '{pattern}' expanded to {matches_found} instrumented targets"
                )
