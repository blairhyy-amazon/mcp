...
def mock_appsignals_client():
    """Mock appsignals client for testing."""
...
class TestAuditServicesFiltering:
    ...
    async def test_audit_services_with_filtering_stats(
        self, mock_appsignals_client, mock_execute_audit_api
    ):
        ...
        with patch(
            ...
            mock_appsignals_client.list_services.return_value = mock_services_response
